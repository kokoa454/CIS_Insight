...
CSRF_TRUSTED_HOSTS = [host.strip() for host in os.getenv('CSRF_TRUSTED_HOSTS', '').split(',') if host.strip()]
...
# PostgreSQL
# 注意: インストール時にDBを作成する必要あり
# DB_NAMEで指定したDBがなければエラーになる
# その後、以下のコマンドを叩く
...
VALIDATION_CODE_LENGTH = 64 # Characters
